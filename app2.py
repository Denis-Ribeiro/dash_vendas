...
Original file is located at
    https://colab.research.google.com/drive/1ftkI9NZ0vSvjHkQ6fXow2akqvl4gbibu
"""
...
df_2020 = pd.read_excel('/content/Base Vendas - 2020.xlsx')
df_2021 = pd.read_excel('/content/Base Vendas - 2021.xlsx')
df_2022 = pd.read_excel('/content/Base Vendas - 2022.xlsx')
df_clientes = pd.read_excel('/content/Cadastro Clientes.xlsx', header=2)
...
# Corrigir colunas de data e valor
...
# Callback: atualizar marcas com base no tipo de produto
@app.callback(
...
# Callback: atualizar produtos com base no tipo e marca
@app.callback(
...
# Callback: atualizar lojas com base nos filtros anteriores
@app.callback(
...
# Callback: atualizar clientes com base nos filtros anteriores
@app.callback(
...
# Callback: atualizar gráficos com base em todos os filtros
@app.callback(
...
def update_graficos(tipo, marcas, produto, lojas, cliente):
    ...
    if dff.empty:
        ...
        fig_empty = px.bar(title=mensagem)
